...
import com.aliyun.spark.common.Phoenix5xConnectionPool
...
/**
  ...
  *
  * spark 控制提交命令依赖jar包：
  * --jars /spark-streaming-kafka-0-10_2.11-2.3.2.jar,/kafka-clients-0.10.0.0.jar,
  * /common-test-0.0.1-SNAPSHOT.jar,/commons-pool2-2.6.2.jar,
  * /ali-phoenix-5.1.0-HBase-2.0.0.1-shaded-thin-client.jar
  */

object SparkStreamingOnKafka010ToPhoenix5x {
